...
idelHandler :: Op Motion MotionState Idle Idle
idelHandler = I.do
  msg <- getInput
  case msg of
    MoveIn pos tms -> I.do
...
overHandler :: (TimerManager, TimeoutKey, Timestamp) -> Op Motion MotionState Idle Over
...
hoverHandler :: Op Motion MotionState Idle Hover
hoverHandler = I.do
  msg <- getInput
  case msg of
